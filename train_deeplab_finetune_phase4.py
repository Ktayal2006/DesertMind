...
# ✅ CHANGE: import Phase 4 dataset
from dataset_phase4_skycrop import OffroadSegDataset
...
def main():
    ...
    # ✅ IMPORTANT: separate load + save
    LOAD_PATH = "best_deeplab.pth"  # Phase 2 model
    SAVE_PATH = "best_deeplab_phase4_skycrop.pth"

    print("Using device:", DEVICE)
    print("Running Phase 4: Sky Crop + Phase 2 pipeline")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_miou > best_miou:
            ...
            print("Saved best Phase 4 model:", best_miou)
        else:
    ...
    print("\nTraining done.")
    print("Phase 4 BEST mIoU:", best_miou)
